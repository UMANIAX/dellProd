...
function (_Component) {
  ...
  _createClass(UserStore, [{
    ...
    value: function componentDidMount() {
      console.log(store.getState()); // localStorage['redux-store'] ? store.dispatch(changeInitState(localStorage['redux-store'])) : null
    }
  }, {
    key: "render",
...
//# sourceMappingURL=6.0277eb4b7dd2747235e6.hot-update.js.map
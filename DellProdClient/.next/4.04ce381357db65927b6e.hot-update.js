...
var customerML = function customerML() {
  ...
  switch (action.type) {
    ...
    case __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].REVIEW_PRODUCT:
      state.reviewCount += 1;
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get("https://service-area.herokuapp.com/ibm?reviewText=".concat(action.review, "&reviewCount=").concat(state.reviewCount + 1, "0&prevReviewScore=").concat(state.reviewSe));
      return state;
...
//# sourceMappingURL=4.04ce381357db65927b6e.hot-update.js.map
  ...
  function ProductCard() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = ProductCard.__proto__ || Object.getPrototypeOf(ProductCard)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "showModal", {
      ...
      value: function value(id, store, cat) {
        ...
        store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_7__actions__["e" /* viewProduct */])(id, cat));
      }
...
function (_Component) {
  ...
  function ProductModal() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = ProductModal.__proto__ || Object.getPrototypeOf(ProductModal)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "reviewModal", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(id) {
  ...
  _createClass(ProductModal, [{
    ...
    value: function componentDidMount() {
      ...
      $("#".concat(this.props.info.asin, " .main.modal")).on('click', function () {
        return $("#".concat(_this2.props.info.asin, " .modal.bought")).modal('show');
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        onClick: function onClick() {
          return _this3.complaintModal(info.asin);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 59
        ...
        onClick: function onClick() {
          return _this3.reviewModal(info.asin);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 66
        ...
        onClick: function onClick() {
          return _this3.complaintFeedbackModal(info.asin);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 75
...
//# sourceMappingURL=6.06d79d65bf9ba68f8c21.hot-update.js.map
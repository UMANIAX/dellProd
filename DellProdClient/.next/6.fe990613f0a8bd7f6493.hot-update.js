...
/* unused harmony export changeInitState */
...
function (_Component) {
  ...
  _createClass(UserStore, [{
    ...
    value: function componentDidMount() {
      console.log(JSON.parse(localStorage['redux-store'])); // localStorage['redux-store'] ? store.dispatch(changeInitState(JSON.parse(localStorage['redux-store']))) : null
    }
  }, {
    key: "render",
...
//# sourceMappingURL=6.fe990613f0a8bd7f6493.hot-update.js.map
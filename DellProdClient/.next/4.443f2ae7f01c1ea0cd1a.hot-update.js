...
/* unused harmony export viewProduct */
...
function (_Component) {
  ...
  _createClass(ProductModal, [{
    ...
    value: function render() {
      var store = this.context.store;
      var info = this.props.info; // store.dispatch(viewProduct(info.asin, info.categories))
...
//# sourceMappingURL=4.443f2ae7f01c1ea0cd1a.hot-update.js.map
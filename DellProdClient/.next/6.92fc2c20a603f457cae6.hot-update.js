...
function (_Component) {
  ...
  _createClass(UserStore, [{
    ...
    value: function componentDidMount() {
      console.log(JSON.parse(localStorage['redux-store'])); // localStorage['redux-store'] ? store.dispatch(changeInitState(localStorage['redux-store'])) : null
    }
  }, {
    key: "render",
...
//# sourceMappingURL=6.92fc2c20a603f457cae6.hot-update.js.map
...
function (_Component) {
  ...
  return ProductPane;
}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]); // {this.props.products.forEach((item, index) => <div className="column"><ProductCard key={index} info={item}/></div>)}
...
//# sourceMappingURL=4.a8dfd54dbd45524c5972.hot-update.js.map